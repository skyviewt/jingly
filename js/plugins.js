...
(function(window) {
    ...
    CBPGridGallery.prototype._navigate = function( dir ) {
        ...
        $(self.slideshow).removeClass('animatable');
        ...
        var slide = function() {
            ...
            $(self.slideshow).addClass('animatable');
    ...
    CBPGridGallery.prototype._closeSlideshow = function( pos ) {
        ...
        $(this.el).removeClass('slideshow-open');
