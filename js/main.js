...
var isArtClicked = false;
var isCodingClicked = false;
var isResumeClicked = false;
var DIMENSION = {};
var PARTS = {};

var jumpTO = undefined;

var timelineJump = new TimelineMax({ paused: true });
var timelineButtons = new TimelineMax({ paused: true });
...
var TEXT = {
  ...
  body: {
    afterClick:
      "I'm Jing, a programmer passionate about coding, design and video games. My past work experience includes Autodesk, McAfee and McGill, currently I am a Generalist Programmer II at Ubisoft Montreal.",
...
var artButton = $(".art");
var codingButton = $(".programming");
var resumeButton = $(".resume");

var redirectLinkButton = $(".animsition-link");
...
function readyFn(jQuery) {
  ...
  DIMENSION.SquareLength = Math.floor(
    Math.min(Math.min($(window).width(), $(window).height()) / 4, 200)
  );
  DIMENSION.StartingPnt =
    (DIMENSION.SquareLength * 2 - DIMENSION.SquareLength) / 2;
  ...
  s.attr({
    viewBox:
      "0 0 " + DIMENSION.SquareLength * 2 + " " + DIMENSION.SquareLength * 2
  });
  ...
  $(".links").css({
    "padding-top":
      DIMENSION.SquareLength / 4 -
      $(".animsition-overlay button").height() / 2 +
      "px"
  });
  ...
  TweenMax.fromTo(
    PARTS.Block.node,
    1,
    { strokeDashoffset: DIMENSION.BlockLength, opacity: 0 },
    {
      fill: COLOR.BlobFill,
      strokeDashoffset: 0,
      opacity: 1,
  ...
  PARTS.SquareGroup = s
    .group(
      PARTS.Block,
      PARTS.RightEye,
      PARTS.RightTopEyeLid,
      PARTS.RightBottomEyeLid,
      PARTS.LeftEye,
      PARTS.LeftTopEyeLid,
      PARTS.LeftBottomEyeLid,
      PARTS.Mouth,
      PARTS.MoustacheLeft,
      PARTS.MoustacheRight,
      PARTS.Tie,
      PARTS.LeftGlass,
      PARTS.RightGlass,
      PARTS.GlassHinge
  ...
  PARTS.Shadow = s
    .ellipse(
      (DIMENSION.LeftEyeX + DIMENSION.RightEyeX) / 2,
      DIMENSION.SquareLength * 2 - DIMENSION.SquareLength / 20,
      DIMENSION.SquareLength / 4,
...
function animateJump() {
  PARTS.SquareGroup.click(function() {
    if (jumpTO !== undefined) {
      clearTimeout(jumpTO);
    }
    squareJump();
...
function squareJump() {
  if (timelineJump.getChildren(true, true, true, 0).length === 0) {
    ...
    timelineJump.add(
      TweenMax.fromTo(
        PARTS.SquareGroup.node,
        0.3,
        { y: 0, scaleX: 0.95, scaleY: 1.05, transformOrigin: "center bottom" },
        {
          y: -DIMENSION.SquareLength,
          scaleX: 1.15,
          scaleY: 0.85,
    ...
    timelineJump.add(
      TweenMax.fromTo(
        PARTS.Shadow.node,
        0.3,
        { scaleX: 0, scaleY: 0, opacity: 1, transformOrigin: "center bottom" },
        {
          scaleX: 1.5,
          scaleY: 1.5,
          opacity: 1,
  ...
  if (timelineButtons.getChildren(true, true, true, 0).length === 0) {
    ...
    if (!isMenuShown) {
      ...
      var tweenVal = Math.random() * (1.02 - 1) + 1;
...
function showArt() {
  ...
  isArtClicked = true;
  redirectLinkButton.attr("href", linkStr.art);
  TweenMax.to(redirectLinkButton, 1, {
    opacity: 1,
    display: "block",
...
function hideArt() {
  if (isArtClicked) {
    TweenMax.to(
      [
        PARTS.PaletteOutline.node,
        PARTS.PaletteColor1.node,
        PARTS.PaletteColor2.node,
        PARTS.PaletteColor3.node,
        PARTS.PaletteColor4.node
      ],
      1,
    ...
    TweenMax.to(PARTS.MoustacheLeft.node, 0.5, {
      strokeDashoffset: DIMENSION.MoustacheLeftLength,
      opacity: 0,
      ease: Power2.easeOut
    });

    TweenMax.to(PARTS.MoustacheRight.node, 0.5, {
      strokeDashoffset: DIMENSION.MoustacheRightLength,
      opacity: 0,
      ease: Power2.easeOut
    });

    TweenMax.to(PARTS.ArtAcc.node, 0.5, {
      x: DIMENSION.SquareLength / 6,
      opacity: 0,
      scaleX: 1.2,
      skewX: -20,
      ease: Back.easeInOut
...
function showCoding() {
  ...
  TweenMax.fromTo(
    [PARTS.LeftGlass.node, PARTS.RightGlass.node, PARTS.GlassHinge.node],
    1,
    { opacity: 0, scale: 0 },
    { opacity: 1, scale: 1, ease: Back.easeInOut }
  );
  if (!isCodingClicked) {
    TweenMax.fromTo(
      PARTS.CodingAcc.node,
      0.8,
      { y: DIMENSION.SquareLength / 6, scaleX: 0.8, scaleY: 1.2 },
      { y: 0, opacity: 1, scale: 1, ease: Back.easeOut }
    );
  }
  isCodingClicked = true;
  redirectLinkButton.attr("href", linkStr.programming);
  TweenMax.to(redirectLinkButton, 1, {
    opacity: 1,
    display: "block",
...
function hideCoding() {
  if (isCodingClicked) {
    TweenMax.to(
      [
        PARTS.BrowserOutline.node,
        PARTS.BrowserButton1.node,
        PARTS.BrowserButton2.node,
        PARTS.BrowserButton3.node
      ],
      1,
    ...
    TweenMax.fromTo(
      ...
      0.5,
      { opacity: 1, scale: 1 },
      { opacity: 0, scale: 0, ease: Back.easeInOut }
    );

    TweenMax.to(PARTS.CodingAcc.node, 0.5, {
      y: DIMENSION.SquareLength / 6,
      scaleX: 0.8,
      opacity: 0,
      scaleY: 1.2,
      ease: Back.easeInOut
...
function showExperience() {
  ...
  redirectLinkButton.attr("href", linkStr.resume);
  TweenMax.to(redirectLinkButton, 1, {
    opacity: 1,
    display: "block",
...
function hideExperience() {
  if (isResumeClicked) {
    ...
    TweenMax.to(PARTS.Tie.node, 0.5, {
      strokeDashoffset: DIMENSION.TieLength,
      opacity: 0,
      ease: Power2.easeOut
    });
