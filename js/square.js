function makeBlockBody(s, heightScale, isSetStroke){
    PARTS.Block = s.rect(DIMENSION.StartingPntX !== undefined ? DIMENSION.StartingPntX : DIMENSION.StartingPnt, DIMENSION.StartingPnt*heightScale, DIMENSION.SquareLength, DIMENSION.SquareLength, DIMENSION.SquareLength/20, DIMENSION.SquareLength/20);
...
function makeEyes(s, heightScale){
    ...
    DIMENSION.RightEyeX = Math.floor((DIMENSION.StartingPntX !== undefined ? DIMENSION.StartingPntX : DIMENSION.StartingPnt) + DIMENSION.SquareLength - DIMENSION.SquareLength / 4.25);
    DIMENSION.EyeY = Math.floor(DIMENSION.StartingPnt*heightScale + DIMENSION.SquareLength / 2.5);
...
function makeTie(s,heightScale, color){
    DIMENSION.TiePnts = {
        ...
        endY: DIMENSION.StartingPnt*heightScale+DIMENSION.SquareLength-DIMENSION.EyeSize/2,
    };
